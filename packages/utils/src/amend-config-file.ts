...
function buildObjectExpression(obj: Record<string, any>) {
 ...
 */
export async function amendConfigFile(appConfigPath: string, pluginConfigPath: string) {
  try {
 ...
 */
export async function removePluginConfig(appConfigPath: string, pluginName: string) {
  try {
