...
describe('merge-env-vars utils', () => {
  before(() => {
    ...
    readFile = mock.method(fs, 'readFile', async (filePath, encoding) => {
    ...
    writeFile = mock.method(fs, 'writeFile', async (filePath, data, encoding) => {
      // You can add logic here to check if the data being written is as expected
